...
/** source: /Users/vinhquangtran/Documents/VSFS/PP/kecal/app/UI/SignUp/default.latte */
final class Template_9d239a2560 extends Latte\Runtime\Template
{
	public const Source = '/Users/vinhquangtran/Documents/VSFS/PP/kecal/app/UI/SignUp/default.latte';
    ...
    ';
        ...
        <div class="login-content">
            <div class="login-box row align-items-center position-relative border-bottom py-2 my-4">
                ...
                <div class="login-box-input position-relative col mt-2">
                    ';
		echo Nette\Bridges\FormsLatte\Runtime::item('username', $this->global)->getControl() /* line 13 */;
		echo '
                    <label class="login-label position-absolute px-2 fw-bold fs-6">Username</label>
                </div>
            </div>
            <div class="login-box row align-items-center position-relative border-bottom py-2 my-4">
                <i class="ri-mail-line col-1 fs-3"></i>
                <div class="login-box-input position-relative col mt-2">
                    ';
		echo Nette\Bridges\FormsLatte\Runtime::item('email', $this->global)->getControl() /* line 20 */;
		echo '
            ...
            <div class="login-box row align-items-center position-relative border-bottom py-2 my-4">
                ...
                <div class="login-box-input position-relative col mt-2">
                    ';
		echo Nette\Bridges\FormsLatte\Runtime::item('password', $this->global)->getControl() /* line 28 */;
		echo '
        ...
        <div class="d-flex justify-content-center">
            ';
		echo Nette\Bridges\FormsLatte\Runtime::item('submit', $this->global)->getControl() /* line 43 */;
		echo '
        </div>
    <p class="pt-3 text-center position-relative">You have an account already? <a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Home:')) /* line 45 */;
		echo '">Log in</a> here</p>
    ';
		echo Nette\Bridges\FormsLatte\Runtime::renderFormEnd(array_pop($this->global->formsStack)) /* line 46 */;
