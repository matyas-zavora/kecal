...
final class Template_282a1394c3 extends Latte\Runtime\Template
{
	...
	';
		$form = $this->global->formsStack[] = $this->global->uiControl['logInForm'] /* line 6 */;
		Nette\Bridges\FormsLatte\Runtime::initializeForm($form);
		echo Nette\Bridges\FormsLatte\Runtime::renderFormBegin($form, []) /* line 6 */;
		echo '
		<h1 class="login-title text-center position-relative">Log in</h1>
		...
		<p class="pt-3 text-center position-relative">Don\'t have an account? <a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Signup:')) /* line 30 */;
		echo '">Sign up</a> here</p>

	';
		echo Nette\Bridges\FormsLatte\Runtime::renderFormEnd(array_pop($this->global->formsStack)) /* line 32 */;
