<?php
// source: /Users/vinhquangtran/Documents/VSFS/PP/kecal/config/common.neon
// source: /Users/vinhquangtran/Documents/VSFS/PP/kecal/config/services.neon
// source: array
...
class Container_c5155d3afa extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\SignUp\SignupPresenter' => [2 => ['application.2']],
	...
	public function createServiceApplication__2(): App\UI\SignUp\SignupPresenter
	{
		$service = new App\UI\SignUp\SignupPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/Users/vinhquangtran/Documents/VSFS/PP/kecal/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/Users/vinhquangtran/Documents/VSFS/PP/kecal/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/Users/vinhquangtran/Documents/VSFS/PP/kecal/temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_c5155d3afa $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Users/vinhquangtran/Documents/VSFS/PP/kecal/temp/cache/latte');
