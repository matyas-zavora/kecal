<?php
// source: /home/zavoram/nginx/kecal/config/common.neon
// source: /home/zavoram/nginx/kecal/config/services.neon
// source: array
...
class Container_88dbb86393 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/zavoram/nginx/kecal/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/zavoram/nginx/kecal/temp/cache');
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_88dbb86393 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/zavoram/nginx/kecal/temp/cache/latte');
